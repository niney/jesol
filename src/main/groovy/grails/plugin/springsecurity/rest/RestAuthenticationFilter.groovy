...
class RestAuthenticationFilter extends GenericFilterBean {
    ...
    CredentialsExtractor credentialsExtractor = new RequestParamsCredentialsExtractor()

    String endpointUrl

    AuthenticationManager authenticationManager = new ProviderManager([new PushAuthenticationProvider()])

    AuthenticationSuccessHandler authenticationSuccessHandler = new RestAuthenticationSuccessHandler()
    AuthenticationFailureHandler authenticationFailureHandler = new BearerTokenAuthenticationFailureHandler()
    ...
    TokenStorageService tokenStorageService = new GrailsCacheTokenStorageService()
