...
<html>
    ...
    <body>
        ...
        <div id="show-productInfo" class="content scaffold-show" role="main">
            ...
            <f:display bean="productInfo" />
            </ol>
            <g:form resource="${productInfo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${productInfo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
